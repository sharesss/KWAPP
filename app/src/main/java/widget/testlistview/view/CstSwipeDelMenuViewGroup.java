package widget.testlistview.view;
...
public class CstSwipeDelMenuViewGroup extends ViewGroup {
    ...
    private MenuOnItemClick mMenuOnItemClick;
    ...
    public void setMenuOnItemClick(MenuOnItemClick mMenuOnItemClick) {
...
/*                    if (!mScroller.isFinished()) {
    ...
    public void smoothExpand() {
       flg=false;
        MessageData.getInstance().setLeftItemDleTag(true);
    ...
    public void smoothClose() {
        if(flg==true && MessageData.getInstance().isDelTag()){
            MessageData.getInstance().setLeftItemDleTag(false);
        }
        flg=true;
/*        mScroller.startScroll(getScrollX(), 0, -getScrollX(), 0);
    ...
    public interface MenuOnItemClick{
