...
import com.thindo.base.Utils.Logger;
import com.ts.fmxt.R;


public class FMBProgressDialog extends Dialog {
	...
	public FMBProgressDialog(Context context) {
		super(context, android.R.style.Theme_Translucent_NoTitleBar);
		
		LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		layout = inflater.inflate(R.layout.progress_dialog_mvc,(ViewGroup) findViewById(R.id.dialog_layout_root));
