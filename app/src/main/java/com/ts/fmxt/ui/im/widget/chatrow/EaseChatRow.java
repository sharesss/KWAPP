...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void initView() {
        ...
        tv_send_gif_num = (TextView) findViewById(R.id.tv_send_gif_num);

        tv_sys_msg = (TextView) findViewById(R.id.tv_sys_msg);
        ...
        if (adapter instanceof EaseMessageAdapter) {
            ...
            if (message.direct() == Direct.SEND) {
                ...
                if (((EaseMessageAdapter) adapter).getOtherBuddleBg() != null) {
                    Drawable temp = ((EaseMessageAdapter) adapter).getOtherBuddleBg();
                    userAvatarView.setImageDrawable(temp);
