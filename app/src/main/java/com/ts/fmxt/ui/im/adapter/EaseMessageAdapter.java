...
import com.ts.fmxt.ui.im.widget.chatrow.EaseChatRowImage;
import com.ts.fmxt.ui.im.widget.chatrow.EaseChatRowLocation;
import com.ts.fmxt.ui.im.widget.chatrow.EaseChatRowText;
import com.ts.fmxt.ui.im.widget.chatrow.EaseChatRowVideo;
import com.ts.fmxt.ui.im.widget.chatrow.EaseChatRowVoice;
...
public class EaseMessageAdapter extends BaseAdapter {
    ...
    public int getItemViewType(int position) {
        ...
        if (message.getType() == EMMessage.Type.TXT) {
            if (message.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false) || !StringUtils.isEmpty(message.getStringAttribute("type", ""))) {
    ...
    protected EaseChatRow createChatRow(Context context, EMMessage message, int position) {
        ...
        switch (message.getType()) {
            case TXT:
                boolean flg = message.getBooleanAttribute("groupName", false);
                String type = message.getStringAttribute("type", "");
                if (message.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false) || !StringUtils.isEmpty(type)) {
...
//                        chatRow = new EaseChatRowGIFExpression(context, message, position, this);
//                    } else {
