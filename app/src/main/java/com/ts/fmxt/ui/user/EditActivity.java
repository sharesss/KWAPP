 ...
 * 编辑质料界面
 */
public class EditActivity extends FMBaseActivity {
    ...
    private void initView() {
        ...
        if(type==100){
            navigationView.setTitle(R.string.title_edit_nick_name, new View.OnClickListener() {
                @Override
        ...
        if(type==200){
            navigationView.setTitle(R.string.title_edit_compay_name, new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    finish();
                }
        ...
        if(type==300){
            navigationView.setTitle(R.string.title_edit_position_name, new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    finish();
                }
