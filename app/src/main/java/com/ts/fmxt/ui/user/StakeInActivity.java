...
public class StakeInActivity  extends FMBaseTableActivity {
    ...
    private void initView(){
        ...
        navigationView.setTitle("拍得股权", new View.OnClickListener() {
            @Override
    ...
    private void FrozenDepositRequest(){
        ...
        staff.put("dataType", String.valueOf(0));
                            ...
                            if (!js.isNull("statsMsg")) {
                                ...
                                if(stats.equals("1")){
                                    ...
                                    if (!js.isNull("equities")) {
                                        ...
                                        adapter = new StockAuctionAdapter(StakeInActivity.this, tableList.getArrayList(),1);
                                        refresh_lv.setAdapter(adapter);
                                    }
                                    stopRefreshState();
                                    mEmptyView.setVisibility(View.GONE);
                                }else{
                                    ToastHelper.toastMessage(StakeInActivity.this,msg);
                                    stopRefreshState();
                                    mEmptyView.setVisibility(View.VISIBLE);
                                }
                            }
