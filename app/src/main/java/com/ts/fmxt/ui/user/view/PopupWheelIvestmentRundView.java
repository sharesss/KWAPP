 ...
 * 轮次
 */
public class PopupWheelIvestmentRundView extends BaseEventPopup implements OnClickListener  {
...
//    private UserInComeEntity info;
    ...
    public PopupWheelIvestmentRundView(Activity context, String money) {
        super(context);
        this.moneys = money;
        ...
        switch (v.getId()) {
            case R.id.tv_finish:
                if (mWheelListener != null)
                    mWheelListener.completeCall(money,id, 3);
