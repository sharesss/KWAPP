...
import com.ts.fmxt.ui.im.model.EaseDefaultEmojiconDatas;
import com.ts.fmxt.ui.im.utils.EaseSmileUtils;
import com.ts.fmxt.ui.im.widget.emojicon.EaseEmojiconMenu;
import com.ts.fmxt.ui.im.widget.emojicon.EaseEmojiconMenuBase;
 ...
 *    EaseChatExtendMenu: grid menu with image, file, location, etcEaseChatPrimaryMenuBase
 EaseChatPrimaryMenu
    ...
    protected void processChatMenu() {
        ...
        emojiconMenu.setEmojiconMenuListener(new EaseEmojiconMenuBase.EaseEmojiconMenuListener() {
            ...
            public void onExpressionClicked(EaseEmojicon emojicon) {
                if(emojicon.getType() == EaseEmojicon.Type.BIG_EXPRESSION || emojicon.getType() == EaseEmojicon.Type.FM_EXPRESSION) {
                    if(listener != null){
