...
/**
 * Created by kp on 2017/12/4.
 */

public class ProjectHighlightsItem implements BaseViewItem {
    ProgressUpdateEntity info;
    DiscoverDetailsActivity context;

    public ProjectHighlightsItem(Activity context) {
    ...
    public View createView(ViewGroup parent) {
        return LayoutInflater.from(parent.getContext()).inflate(R.layout.item_project_highlights, parent, false);
    }
