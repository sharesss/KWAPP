...
import com.ts.fmxt.ui.im.domain.InviteMessage;
...
import com.ts.fmxt.ui.im.model.EaseNotifier;
import com.ts.fmxt.ui.im.parse.UserProfileManager;
import com.ts.fmxt.ui.im.receiver.CallReceiver;
import com.ts.fmxt.ui.im.utils.EaseCommonUtils;
import com.ts.fmxt.ui.im.utils.PreferenceManager;
...
public class IMHelper {
    ...
    protected void onConnectionConflict(){
        Intent intent = new Intent(appContext, MainFrameActivity.class);
...
//                    }
    ...
    public boolean isPrivilegeOfSecurities(EMMessage message) {
        String TYPE =message.getStringAttribute(PrivilegeOfSecuritiesEntity.kSendCouponMessageSuccess,null);
        if(TYPE==null){
            return false;
        }
        if(TYPE.equals("kSendCouponMessageSuccess")){
            message.getStringAttribute(PrivilegeOfSecuritiesEntity.kSendCouponMessageSuccess,null);
            message.getStringAttribute(PrivilegeOfSecuritiesEntity.kSendCouponMessageSuccessCashCouponIdKey,null);
            message.getStringAttribute(PrivilegeOfSecuritiesEntity.kSendCouponMessageSuccessDiscountMoneyKey,null);
            message.getStringAttribute(PrivilegeOfSecuritiesEntity.kSendCouponMessageSuccessLogoKey,null);
            message.getStringAttribute(PrivilegeOfSecuritiesEntity.kSendCouponMessageSuccessStoreIdIdKey,null);
            message.getStringAttribute(PrivilegeOfSecuritiesEntity.kSendCouponMessageSuccessTotalMoneyKey,null);
            message.getStringAttribute(PrivilegeOfSecuritiesEntity.kSendCouponMessageSuccessLocationKey,null);
            message.getStringAttribute(PrivilegeOfSecuritiesEntity.kSendCouponMessageSuccessIsShareKey,null);
