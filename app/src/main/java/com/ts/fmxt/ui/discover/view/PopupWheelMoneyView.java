 ...
 * 选择金额
 */
public class PopupWheelMoneyView extends BaseEventPopup implements OnClickListener  {
...
//    private UserInComeEntity info;
    ...
    public PopupWheelMoneyView(Activity context, String money,Double InitiateAmount,int FinancingAmount) {
        super(context);
