...
public class EaseCommonUtils {
    ...
    public static EMMessage createTuzkiMessage(String toChatUsername, String expressioName, String identityCode) {


        EMMessage message = EMMessage.createTxtSendMessage("[动态表情]", toChatUsername);

        if (identityCode != null) {
            message.setAttribute("groupName", "tuzki");
            message.setAttribute("codeId", identityCode);
            message.setAttribute("type", "GIF");
            message.setAttribute(EaseConstant.MESSAGE_ATTR_EXPRESSION_ID, identityCode);
        }
        message.setAttribute(EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, true);
        return message;
    ...
    public static EMMessage createFMMessage(String toChatUsername, String url, String identityCode) {

        EMMessage message = EMMessage.createTxtSendMessage("[疯蜜表情]", toChatUsername);
        if (identityCode != null) {
            message.setAttribute("groupName", "FM");
            message.setAttribute("codeId", identityCode);
            message.setAttribute("type", "GIF");
            message.setAttribute("kLLEmotionTypeFacialCustomGif", url);
            message.setAttribute(EaseConstant.MESSAGE_ATTR_EXPRESSION_ID, identityCode);
        }
        message.setAttribute(EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, true);
        return message;
    ...
    public static String getMessageDigest(EMMessage message, Context context) {
        ...
        switch (message.getType()) {
            ...
            case TXT:
                ...
                } else if (message.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false) || !StringUtils.isEmpty(message.getStringAttribute("type", ""))) {
