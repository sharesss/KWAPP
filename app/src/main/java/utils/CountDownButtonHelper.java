...
//                button.setBackgroundResource(R.color.main_bg_color);
    ...
    public void setBackgroundCode(boolean code) {
        this.code = code;
...
//        button.setBackgroundResource(R.color.default_light_grey_color);
